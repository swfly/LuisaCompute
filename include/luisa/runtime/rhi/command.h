...
public:
    ...
    public:
        ...
        virtual void visit(const Argument::Texture &resource, Usage usage) noexcept = 0;
        virtual void visit(const Argument::Buffer &resource, Usage usage) noexcept = 0;
        virtual void visit(const Argument::BindlessArray &resource, Usage usage) noexcept = 0;
        virtual void visit(const Argument::Accel &resource, Usage usage) noexcept = 0;
    };
...
public:
    ...
    void traverse_arguments(F &&f) const noexcept {
        ...
        public:
            ...
            void visit(const Argument::Texture &resource, Usage usage) noexcept override { _f(resource, usage); }
            void visit(const Argument::Buffer &resource, Usage usage) noexcept override { _f(resource, usage); }
            void visit(const Argument::BindlessArray &resource, Usage usage) noexcept override { _f(resource, usage); }
            void visit(const Argument::Accel &resource, Usage usage) noexcept override { _f(resource, usage); }
        };
        Adapter adapter{f};
